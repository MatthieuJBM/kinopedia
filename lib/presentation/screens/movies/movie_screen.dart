...
import 'package:kinopedia/presentation/providers/providers.dart';
import 'package:kinopedia/presentation/providers/storage/favorite_movies_provider.dart';
...
class _CustomSliverAppBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final size = MediaQuery.of(context).size; // Dimensions of the mobile
